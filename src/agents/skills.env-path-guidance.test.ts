...
const legacyAgentSessionDir = "~/.openclaw/agents/<agentId>/sessions";
...
const CASES: GuidanceCase[] = [
  {
    ...
    forbidden: [
      `for f in ${legacyAgentSessionDir}/*.jsonl`,
      `rg -l "phrase" ${legacyAgentSessionDir}/*.jsonl`,
      `${legacyAgentSessionDir}/<id>.jsonl`,
    ],
  },
  {
