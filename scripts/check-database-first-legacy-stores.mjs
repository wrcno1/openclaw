...
const allowedExactPaths = new Set([
  ...
  "src/infra/device-identity-legacy.ts",
  "src/infra/pairing-files-legacy.ts",
  "src/infra/push-apns-legacy.ts",
  "src/infra/push-web-legacy.ts",
  "src/infra/voicewake-routing-legacy.ts",
  "src/infra/voicewake-legacy.ts",
  "src/memory-host-sdk/dreaming-state-migration.ts",
  "src/plugins/conversation-binding-legacy.ts",
